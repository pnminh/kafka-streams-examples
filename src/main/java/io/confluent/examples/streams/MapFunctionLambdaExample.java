 ...
 * <pre>
 * {@code
 * $ java -cp target/kafka-streams-examples-5.3.1-standalone.jar io.confluent.examples.streams.MapFunctionLambdaExample
 * }
 * </pre>
...
public class MapFunctionLambdaExample {
  ...
  public static void main(final String[] args) {
    ...
    final KStream<byte[], String> uppercasedWithMapValues = textLines.mapValues((ValueMapper<String, String>) String::toUpperCase);
